...
('Allow', 22, 33, '.*Controller.Centro.update', NULL, 'arguments.get("entity").idCentro==identity.centro.idCentro', 1, NULL),
...
('Allow', 22, 33, '.*Controller.Usuario.update', NULL, 'arguments.get("entity").centro.idCentro==identity.centro.idCentro', 1, NULL),
...
('Allow', 22, 33, '.*Controller.CertificadoTitulo.update', NULL, 'arguments.get("entity").centro.idCentro==identity.centro.idCentro', 1, NULL),
...
('Allow', 22, 33, '.*Controller.Empresa.update', NULL, 'arguments.get("entity").centro.idCentro==identity.centro.idCentro', 1, NULL),
...
('Allow', 22, 33, '.*Controller.Oferta.update', NULL, 'arguments.get("entity").empresa.centro.idCentro==identity.centro.idCentro', 1, NULL),
