...
angular.module("common").config(['serviceFactoryProvider', function (serviceFactoryProvider) {
    ...
    ServiceImplCaptcha.$inject = ['entityName', 'repositoryFactory', '$q'];
    function ServiceImplCaptcha(entityName, repositoryFactory, $q) {
        ...
        this.getCaptcha = function () {
            ...
            this.repository.getCaptcha().then(function (captcha) {
    ...
    serviceFactoryProvider.addService("Captcha", ServiceImplCaptcha);
